---
title: "Introtesttest12345678910"
description: "Welcome to the new home for your documentation bruh"
---
...
[Install the Mintlify CLI](https://docs.mintlify.com/development/cli)

<Card title="Start here" icon="rocket" horizontal href="/quickstart">
  Follow our three step quickstart guide.
</Card>

<Tooltip tip="Application Programming Interface: a set of protocols for software applications to communicate.">API</Tooltip> documentation helps developers understand how to integrate with your service.
