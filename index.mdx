...
---
<img src="/images/hero-dark.png" alt="Getting started guide" />

<img 
  src="/images/hero-dark.png" 
  alt="Getting started guide" 
  style="padding: 20px; border: 2px solid #e2e8f0; border-radius: 8px; background-color: #ffffff; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1); max-width: 100%; height: auto; display: block; margin: 0 auto;" 
/>
<img 
  src="/images/hero-dark.png" 
  alt="Getting started guide" 
