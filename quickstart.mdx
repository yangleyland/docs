...
icon: "linear"
---
import MySnippet from "/snippets/snippet-test.mdx";

<MySnippet/>

This quickstart guide shows you how to set up and deploy your documentation site in minutes.1

update quickstart123
