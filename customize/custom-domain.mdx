...
To host your documentation on a custom domain, we want this to show up
...
<Frame>
  ![Sample CNAME settings for a custom domain hosted on Vercel.](https://mintlify-assets.b-cdn.net/mintlify-dns.png)
</Frame>
