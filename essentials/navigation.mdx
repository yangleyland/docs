...
The navigation menu is the list of links on

![Description of the image](/images/hero-dark.png)
...
Our navigation syntax is recursive which means you

can make nested navigation groups. You don't need to include `.mdx` in page
