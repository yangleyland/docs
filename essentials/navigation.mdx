...
Our navigation syntax is recursive which means you can make nested navigation groups. You don't need to include `.mdx` in page <img src="/images/hero-dark.png" alt="Description of the image"/>names <img src="/images/hero-dark.png" alt="Description of the image"/>.
